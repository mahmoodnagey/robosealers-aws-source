...
module.exports = {
    ...
    createOperationValidation: {
        body: joi.object().required().keys({
            ...
            batteryHours: joi.number().required().messages({
                "number.base": "please enter a valid battery hours",
                "any.required": "battery hours is required",
            }),
    ...
    updateOperationValidation: {
        body: joi.object().optional().keys({
            ...
            batteryHours: joi.number().optional().messages({
                "number.base": "please enter a valid battery hours"
            }),
