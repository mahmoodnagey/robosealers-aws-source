...
exports.login = async (req, res) => {
    try {
        ...
        const operationResultObject = await userRepo.comparePassword(email, password);
        ...
        if (operationResultObject.result.role == "user") await userRepo.updateDirectly(operationResultObject.result._id, { token })
